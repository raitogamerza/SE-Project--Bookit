...
const Profile = () => {
    ...
    return (
        <div className="min-h-[calc(100vh-64px)] bg-[var(--color-background)] pb-12 relative">
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 mt-8 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                    ...
                    <div className="lg:col-span-1 space-y-6">
                        {/* Navigation */}
                        <div className="bg-[var(--color-surface)] rounded-3xl shadow-sm border border-[var(--color-secondary)]/20 p-4 space-y-2">
                            <button
                                onClick={() => setActiveTab('overview')}
                                className={`w-full flex items-center gap-4 px-4 py-3 rounded-2xl font-bold transition-all duration-300 ${activeTab === 'overview' ? 'bg-[var(--color-primary)] text-[var(--color-text-inverse)] shadow-lg shadow-[var(--color-primary)]/20 translate-x-1' : 'text-[var(--color-text-light)] hover:bg-[var(--color-secondary)]/10 hover:text-[var(--color-primary-dark)]'}`}
                            >
                                <LayoutGrid className="w-5 h-5" /> Overview
                            </button>
                            <button
                                onClick={() => setActiveTab('settings')}
                                className={`w-full flex items-center gap-4 px-4 py-3 rounded-2xl font-bold transition-all duration-300 ${activeTab === 'settings' ? 'bg-[var(--color-primary)] text-[var(--color-text-inverse)] shadow-lg shadow-[var(--color-primary)]/20 translate-x-1' : 'text-[var(--color-text-light)] hover:bg-[var(--color-secondary)]/10 hover:text-[var(--color-primary-dark)]'}`}
                            >
                        ...
                        <div className="bg-gradient-to-br from-[var(--color-accent)]/20 to-[var(--color-surface)] rounded-3xl shadow-sm border border-[var(--color-secondary)]/20 p-6">
                            ...
                            <div className="grid grid-cols-3 gap-2">
                                {[1, 2, 3].map((i) => (
                                    <div key={i} className="aspect-square rounded-2xl bg-[var(--color-surface)] border border-[var(--color-secondary)]/20 flex flex-col items-center justify-center gap-1 group cursor-help transition-all hover:border-[var(--color-primary)] hover:shadow-md">
                    ...
                    <div className="lg:col-span-3">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    {[
                                        ...
                                        <div key={i} className="bg-[var(--color-surface)] p-6 rounded-3xl border border-[var(--color-secondary)]/20 shadow-sm flex flex-col items-center text-center group hover:-translate-y-1 transition-transform duration-300">
                                            ...
                                            <p className="text-xs font-bold text-[var(--color-text-light)] uppercase tracking-wider">{stat.label}</p>
                                        </div>
                                    ))}
                                </div>
                        ...
                        {activeTab === 'settings' && (
                            <div className="bg-[var(--color-surface)] rounded-3xl shadow-lg shadow-[var(--color-primary)]/5 border border-[var(--color-secondary)]/20 overflow-hidden animate-fade-in-up">
                                <div className="p-8 md:p-10">
                                    <div className="flex items-center justify-between mb-8">
                                        <div>
                                            <h2 className="text-2xl font-bold text-[var(--color-primary-dark)]">Edit Profile</h2>
                                            <p className="text-[var(--color-text-light)] mt-1">Update your personal information</p>
                                        </div>
                                        <div className="w-12 h-12 bg-[var(--color-background)] rounded-2xl flex items-center justify-center text-[var(--color-primary)]">
                                    ...
                                    <form onSubmit={handleUpdateProfile} className="space-y-8">
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                            <div className="md:col-span-2">
                                                <label className="block text-sm font-bold text-[var(--color-text-main)] mb-2 uppercase tracking-wide">Display Name</label>
                                                <div className="relative group">
                                                    <input
                                                        type="text"
                                                        value={fullName}
                                                        onChange={(e) => setFullName(e.target.value)}
                                                        className="w-full pl-12 pr-4 py-4 rounded-2xl border border-[var(--color-secondary)]/20 bg-[var(--color-background)]/50 focus:bg-[var(--color-surface)] focus:border-[var(--color-primary)] focus:ring-4 focus:ring-[var(--color-primary)]/10 outline-none transition-all font-medium text-lg text-[var(--color-text-main)]"
                                                        placeholder="Your Name"
                                                    />
                                                    <div className="absolute left-4 top-4 w-6 h-6 flex items-center justify-center bg-[var(--color-secondary)]/20 rounded-lg text-[var(--color-text-light)] group-focus-within:bg-[var(--color-primary)] group-focus-within:text-[var(--color-text-inverse)] transition-colors">
                                            ...
                                            <div className="md:col-span-2">
                                                <label className="block text-sm font-bold text-[var(--color-text-main)] mb-2 uppercase tracking-wide">Avatar URL</label>
                                                <div className="relative group">
                                                    <input
                                                        type="url"
                                                        value={avatarUrl}
                                                        ...
                                                        placeholder="https://..."
                                                        className="w-full pl-12 pr-4 py-4 rounded-2xl border border-[var(--color-secondary)]/20 bg-[var(--color-background)]/50 focus:bg-[var(--color-surface)] focus:border-[var(--color-primary)] focus:ring-4 focus:ring-[var(--color-primary)]/10 outline-none transition-all font-medium text-[var(--color-text-main)]"
                                                    />
                                                    <div className="absolute left-4 top-4 w-6 h-6 flex items-center justify-center bg-[var(--color-secondary)]/20 rounded-lg text-[var(--color-text-light)] group-focus-within:bg-[var(--color-primary)] group-focus-within:text-[var(--color-text-inverse)] transition-colors">
                                            ...
                                            <div className="md:col-span-2 opacity-60 pointer-events-none">
                                                <label className="block text-sm font-bold text-[var(--color-text-main)] mb-2 uppercase tracking-wide">Email</label>
                                                <div className="relative group">
                                                    <input
                                                        type="email"
                                                        value={user?.email || ''}
                                                        disabled
                                                        className="w-full pl-12 pr-4 py-4 rounded-2xl border border-[var(--color-secondary)]/20 bg-[var(--color-secondary)]/10 font-medium text-[var(--color-text-light)]"
                                                    />
                                                    <div className="absolute left-4 top-4 w-6 h-6 flex items-center justify-center bg-[var(--color-secondary)]/20 rounded-lg text-[var(--color-text-light)]">
                                        ...
                                        <div className="pt-6 border-t border-[var(--color-secondary)]/10 flex justify-end">
                                            <button
                                                disabled={loading}
                                                className="px-8 py-4 bg-[var(--color-primary)] text-[var(--color-text-inverse)] rounded-2xl font-bold hover:bg-[var(--color-primary-dark)] transition-all shadow-lg hover:shadow-xl active:scale-[0.98] disabled:opacity-70 flex items-center gap-3 text-lg"
                                            >
