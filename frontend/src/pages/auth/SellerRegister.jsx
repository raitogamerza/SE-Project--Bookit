        ...
        <div className="min-h-[calc(100vh-64px)] flex items-center justify-center p-4 bg-orange-50/30">
            <div className="bg-[var(--color-surface)] rounded-3xl shadow-xl w-full max-w-4xl overflow-hidden flex flex-col md:flex-row border border-[var(--color-secondary)]/20">
                ...
                <div className="w-full md:w-1/2 p-8 md:p-12">
                    <h2 className="text-3xl font-bold text-[var(--color-text-main)] mb-2">Register as Seller</h2>
                    <p className="text-[var(--color-text-light)] mb-8">Create your store and start selling.</p>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="space-y-1">
                            <label className="text-sm font-medium text-[var(--color-text-main)]">Store Name</label>
                            <div className="relative">
                                <input
                                    type="text"
                                    required
                                ...
                                />
                                <Store className="absolute left-3 top-3.5 w-5 h-5 text-[var(--color-text-light)]" />
                            </div>
                        </div>
