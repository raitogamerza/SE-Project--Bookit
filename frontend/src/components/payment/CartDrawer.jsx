            ...
            {isCartOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed right-0 top-0 h-full w-full max-w-md bg-[var(--color-surface)] shadow-2xl z-50 flex flex-col"
                    >
                        <div className="p-4 border-b border-[var(--color-secondary)]/20 flex items-center justify-between">
                            ...
                            <button
                                onClick={() => setIsCartOpen(false)}
                                className="p-2 hover:bg-[var(--color-secondary)]/10 rounded-full transition-colors text-[var(--color-text-light)]"
                            >
                                <X className="w-6 h-6" />
                            </button>
                        </div>
                        ...
                        {cart.length > 0 && (
                            <div className="p-6 border-t border-[var(--color-secondary)]/20 bg-[var(--color-background)]">
                                ...
                                <Link
                                    to="/checkout"
                                    onClick={() => setIsCartOpen(false)}
                                    className="block w-full py-4 bg-[var(--color-primary)] text-[var(--color-text-inverse)] text-center rounded-xl font-bold hover:bg-[var(--color-primary-dark)] transition-all shadow-lg hover:shadow-xl active:scale-[0.98]"
                                >
                                    Proceed to Checkout
                                </Link>
                            </div>
