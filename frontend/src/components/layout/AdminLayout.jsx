...
const AdminLayout = () => {
    ...
    return (
        <div className="min-h-screen bg-[var(--color-secondary)]/10 flex">
            {/* Sidebar */}
            <aside className="w-64 bg-gray-900 text-[var(--color-text-inverse)] flex flex-col fixed h-full">
                ...
                <nav className="flex-1 p-4 space-y-2 overflow-y-auto">
                    ...
                    <Link to="#" className="flex items-center gap-3 px-4 py-3 text-[var(--color-text-light)] hover:bg-gray-800 hover:text-[var(--color-text-inverse)] rounded-xl transition-colors">
