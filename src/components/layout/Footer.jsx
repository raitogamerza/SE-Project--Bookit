...
const Footer = () => {
    return (
        <footer className="bg-[#FAF7F2] border-t border-[var(--color-secondary)]/30 pt-12 pb-8">
                    ...
                    <div>
                        ...
                        <div className="flex gap-2">
                            <input
                                ...
                                className="flex-1 px-4 py-2 rounded-lg border border-[var(--color-secondary)] bg-white focus:outline-none focus:ring-1 focus:ring-[var(--color-primary)]"
                            />
