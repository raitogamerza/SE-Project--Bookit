            ...
            <section className="relative rounded-3xl overflow-hidden min-h-[500px] flex items-center justify-center text-center">
                ...
                <div className="relative z-10 p-8 max-w-3xl mx-auto text-white">
                    ...
                    <div className="relative max-w-xl mx-auto">
                        ...
                        />
                        <button className="absolute right-2 top-2 bg-[var(--color-primary)] text-white px-6 py-2 rounded-full font-bold hover:bg-[var(--color-primary-dark)] transition-colors">
                            Search
                        </button>
                    </div>
                </div>
