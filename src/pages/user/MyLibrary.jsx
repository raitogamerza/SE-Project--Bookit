        ...
        <div className="space-y-8">
            <div className="flex items-center justify-between">
                ...
                <div className="flex gap-2">
                    <button className="px-4 py-2 bg-[var(--color-primary)] text-white rounded-lg font-medium">Currently Reading</button>
                    <button className="px-4 py-2 bg-white border border-[var(--color-secondary)]/30 rounded-lg font-medium hover:bg-[var(--color-secondary)]/10">Finished</button>
                </div>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {myBooks.map(book => (
                    <div key={book.id} className="bg-white p-4 rounded-2xl shadow-sm border border-[var(--color-secondary)]/20 flex gap-4 hover:shadow-md transition-shadow">
            ...
            {myBooks.length === 0 && (
                <div className="text-center py-20 bg-[var(--color-secondary)]/5 rounded-3xl">
                    ...
                    <Link to="/explore" className="px-6 py-3 bg-[var(--color-primary)] text-white rounded-full font-bold hover:bg-[var(--color-primary-dark)] transition-colors">
                        Explore Books
                    </Link>
                </div>
            )}
