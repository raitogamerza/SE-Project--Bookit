...
const ReadPage = () => {
    ...
    return (
        <div className="fixed inset-0 bg-[#FDFBF7] z-50 flex flex-col">
            {/* Reader Controls */}
            <header className="px-4 py-3 bg-white border-b border-[var(--color-secondary)]/20 flex items-center justify-between shadow-sm">
                <Link to="/my-library" className="p-2 hover:bg-gray-100 rounded-full transition-colors">
                ...
                <div className="flex gap-2">
                    <button className="p-2 hover:bg-gray-100 rounded-full text-[var(--color-text-light)]">
            ...
            {/* Footer / Progress */}
            <footer className="px-6 py-4 bg-white border-t border-[var(--color-secondary)]/20">
